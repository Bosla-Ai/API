        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedTrack = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserInputAsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RecommendedResourcesJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    Framework = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeepDive = table.Column<bool>(type: "bit", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoadMapId1 = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LlmInteractions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LlmInteractions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LlmInteractions_RoadMaps_RoadMapId1",
                        column: x => x.RoadMapId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LlmInteractions_RoadMapId1",
